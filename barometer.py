...
def get_real_weather_data():
    try:
        url = (
            ...
            "&hourly=surface_pressure,weather_code,temperature_2m,relative_humidity_2m,precipitation"
        ...
        if res.status_code == 200:
            ...
            if 'hourly' in res_json:
                ...
                df = pd.DataFrame({
                    ...
                    'SeaPress': hourly['surface_pressure'], # APIが返す地表気圧
...
def get_weather_string(code, rain_val=0.0):
    ...
    # 雨コードであっても、直近の降水予測が0mmなら「くもり」にする
